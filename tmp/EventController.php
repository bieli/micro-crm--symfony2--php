...
class EventController extends Controller
{
     ...
     * Lists all Event entities.
     *
     * @Route("/customer/{id}", name="event_customer")
     * @Method("GET")
     * @Template("BieliNetMicroCrmBundle:Event:index.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("BieliNetMicroCrmBundle:Event:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BieliNetMicroCrmBundle:Event')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BieliNetMicroCrmBundle:Event:edit.html.twig")
     */
