...
use BieliNet\Bundle\MicroCrmBundle\Entity\Provider;
use BieliNet\Bundle\MicroCrmBundle\Form\ProviderType;
use BieliNet\Bundle\MicroCrmBundle\Form\ProviderFilterType;
...
class ProviderController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new ProviderFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('BieliNetMicroCrmBundle:Provider')->createQueryBuilder('e');

        // Reset filter
        if ($request->get('filter_action') == 'reset') {
            $session->remove('ProviderControllerFilter');
        }
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($filterForm->isValid()) {
                ...
                $session->set('ProviderControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('ProviderControllerFilter')) {
                $filterData = $session->get('ProviderControllerFilter');
                $filterForm = $this->createForm(new ProviderFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('provider', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("BieliNetMicroCrmBundle:Provider:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BieliNetMicroCrmBundle:Provider')->find($id);
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new ProviderType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     * @Method("PUT")
     * @Template("BieliNetMicroCrmBundle:Provider:edit.html.twig")
     */
