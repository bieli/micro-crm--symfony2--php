...
class CustomerController extends Controller
{
    ...
    */
     ...
     * @Method("POST")
     * @Template("BieliNetMicroCrmBundle:Customer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BieliNetMicroCrmBundle:Customer')->find($id);
     ...
     * @Method("PUT")
     * @Template("BieliNetMicroCrmBundle:Customer:edit.html.twig")
     */
