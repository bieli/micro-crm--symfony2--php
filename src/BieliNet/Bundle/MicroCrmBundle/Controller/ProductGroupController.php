...
use BieliNet\Bundle\MicroCrmBundle\Entity\ProductGroup;
use BieliNet\Bundle\MicroCrmBundle\Form\ProductGroupType;
use BieliNet\Bundle\MicroCrmBundle\Form\ProductGroupFilterType;
...
class ProductGroupController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $filterForm = $this->createForm(new ProductGroupFilterType());
        $em = $this->getDoctrine()->getManager();
        $queryBuilder = $em->getRepository('BieliNetMicroCrmBundle:ProductGroup')->createQueryBuilder('e');

        // Reset filter
        if ($request->get('filter_action') == 'reset') {
            $session->remove('ProductGroupControllerFilter');
        }
        ...
        if ($request->get('filter_action') == 'filter') {
            ...
            if ($filterForm->isValid()) {
                ...
                $session->set('ProductGroupControllerFilter', $filterData);
            }
        } else {
            // Get filter from session
            if ($session->has('ProductGroupControllerFilter')) {
                $filterData = $session->get('ProductGroupControllerFilter');
                $filterForm = $this->createForm(new ProductGroupFilterType(), $filterData);
                $this->get('lexik_form_filter.query_builder_updater')->addFilterConditions($filterForm, $queryBuilder);
            }
        }
    ...
    */
    protected function paginator($queryBuilder)
    {
        ...
        {
            return $me->generateUrl('productgroup', array('page' => $page));
        };
     ...
     * @Method("POST")
     * @Template("BieliNetMicroCrmBundle:ProductGroup:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BieliNetMicroCrmBundle:ProductGroup')->find($id);
     ...
     * @Method("PUT")
     * @Template("BieliNetMicroCrmBundle:ProductGroup:edit.html.twig")
     */
