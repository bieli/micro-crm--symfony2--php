...
class SellerFilterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('passwordHash', 'filter_text')
            ->add('activityHash', 'filter_text')
    ...
    {
        return 'bielinet_bundle_microcrmbundle_sellerfiltertype';
    }
}
